...
DATASETS_DIR = './data/'
URL = '/Users/norma.perez/Documents/GitHub/MLOps_Final_Project/mlops_final_project/mlops_final_project/data/Hotel_Reservations.csv'
...
TRAINED_MODEL_DIR = './mlops_final_project/models/'
